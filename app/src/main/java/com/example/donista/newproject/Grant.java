...
public class Grant {
    ...
    public String getGrantDescription() {return grantDescription;}
    public void setGrantDescription(String grantDescription){this.grantDescription=grantDescription;}

    public String getGrantDeadline(){return grantDeadline;}
    public void  setGrantDeadline(String grantDedline){this.grantDeadline=grantDedline;}
}
